...
local bytes = dataToBytes("iif", 100, 200, 3.14)
-- Formato: int (32bits), int (32bits), float (32bits)

-- Converter bytes de volta para dados
local a, b, c = bytesToData("iif", bytes)
